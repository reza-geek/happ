...
//import { DateAdapter } from "jalali-moment";
...
@Component({
  selector: 'app-material.persian-date.adapter',
  templateUrl: './material.persian-date.adapter.component.html',
  styleUrls: ['./material.persian-date.adapter.component.css']
})
export class MaterialPersianDateAdapterComponent {
