        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Catheter_Name = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Clearance_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Clearance_Type = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Event_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Event_Name = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Part_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Part_Name = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dr_NationalCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Insert_Date = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    User_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Clearance_DESC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Clearance_DateTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    User_ID = table.Column<int>(type: "int", nullable: false),
                    Part_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Catheter_ID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Catheterisation_Catheter_Catheter_ID",
                        column: x => x.Catheter_ID,
                        principalTable: "Catheter",
                        principalColumn: "Catheter_ID");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Catheterisation_Doctor_Dr_ID",
                        column: x => x.Dr_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catheter_Catheter_Name",
                table: "Catheter",
                column: "Catheter_Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catheterisation_Catheter_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clearance_Clearance_Type",
                table: "Clearance",
                column: "Clearance_Type",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Doctor_Dr_NationalCode",
                table: "Doctor",
                column: "Dr_NationalCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_Event_Name",
                table: "Event",
                column: "Event_Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Part_Part_Name",
                table: "Part",
                column: "Part_Name",
                unique: true);
